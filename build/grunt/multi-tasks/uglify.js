...
module.exports = {
    scripts: {
        ...
        files: {
            '<%= publicPath %>/js/management.min.js': ['public/js/management.js'],
            ...
            '<%= publicPath %>/js/subscriptions.min.js': ['public/js/subscriptions.js'],
            '<%= adminPath %>/js/admin.min.js': ['admin/js/admin.js'],
            '<%= adminPath %>/js/demo.min.js': ['admin/js/demo.js'],
            '<%= adminPath %>/js/subscriptions.min.js': ['admin/js/subscriptions.js'],
            ...
            '<%= adminPath %>/js/agent-metabox.min.js': ['admin/js/agent-metabox.js'],
