 ...
 * @property string $agents_layout
 * @property string $properties_default_sorting_option
 * @property string $agencies_default_sorting_option
 * @property string $agents_default_sorting_option
 ...
 * @property string $agent_register_subtitle
 * @property string $agent_register_title
 ...
 * @property integer $default_agent_avatar_attachment_id
 * @property integer $default_agency_avatar_attachment_id
 * @property integer $is_address_components_clickable
 * @property integer $is_clusters_enabled
 * @property integer $is_agent_comments_enabled
 * @property integer $is_agency_comments_enabled
 * @property integer $is_agent_commenting_enabled
 * @property integer $is_agency_commenting_enabled
 * @property integer $is_agent_rating_enabled
 * @property integer $is_agency_rating_enabled
 * @property integer $is_layout_switcher_enabled
 * @property integer $is_agents_layout_switcher_enabled
 * @property integer $is_agent_member_since_enabled
 * @property integer $is_agency_member_since_enabled
 * @property integer $is_white_label_enabled
 * @property integer $is_properties_sorting_enabled
 * @property integer $is_agents_sorting_enabled
 * @property integer $is_agencies_sorting_enabled
 * @property integer $is_price_enabled
 * @property integer $is_properties_wishlist_enabled
 * @property integer $is_agents_wishlist_enabled
 * @property integer $is_agencies_wishlist_enabled
 * @property integer $is_listing_address_enabled
 * @property integer $is_labels_enabled
 * @property integer $is_sharing_enabled
 * @property integer $is_agents_sharing_enabled
 * @property integer $is_agencies_sharing_enabled
 * @property integer $is_agent_position_enabled
 ...
 * @property integer $is_frontend_management_enabled
 * @property integer $manual_listing_approve
 * @property integer $is_agents_enabled
 * @property integer $is_agenies_enabled
 ...
 * @property integer $is_subscriptions_enabled
 * @property integer $is_lightbox_disabled
 * @property integer $is_download_font
 * @property integer $is_admin_listing_added_by_agent_enabled
 * @property integer $is_admin_listing_published_enabled
 * @property integer $is_agent_listing_published_enabled
 * @property integer $is_agent_listing_submitted_enabled
 * @property integer $is_new_user_registered_admin_enabled
 ...
 * @property integer $saved_searches_per_page
 * @property integer $agency_agents_per_page
 * @property integer $agent_comments_per_page
 * @property integer $agency_comments_per_page
 * @property integer $agents_per_page
 * @property integer $agencies_per_page
 * @property integer $wishlist_properties_per_page
 * @property integer $agent_listings_per_page
 * @property integer $agency_listings_per_page
 * @property integer $requests_per_page
 * @property integer $login_page_id
 * @property integer $property_management_page_id
 * @property integer $profile_page_id
 * @property integer $map_search_page_id
 * @property integer $search_results_page_id
 * @property integer $agent_agency_search_results_page_id
 ...
 * @property integer $pricing_page_id
 ...
 * @property array $agents_sorting_options
 * @property array $agencies_sorting_options
 ...
 * @property array $listing_meta_icons
 *
 * @property string $subscription_tr_subscriptions_btn
 * @property string $subscription_tr_otp_btn
 * @property string $subscription_tr_general_title
 * @property string subscription_tr_general_subtitle
 * @property string $subscription_tr_signup_title
 * @property string $subscription_tr_signup_subtitle
 * @property string $subscription_tr_hl_with_subscriptions_title
 * @property string $subscription_tr_hl_with_subscriptions_subtitle
 * @property string $subscription_tr_hl_with_otp_title
 * @property string $subscription_tr_hl_with_otp_subtitle
 * @property string $subscription_tr_hl_title
 * @property string $subscription_tr_subtitle
 */
class Es_Settings_Container
{
	/**
	...
	public static function get_available_settings( $force = false ) {
		...
		if ( ! static::$settings_list || $force ) {
			static::$settings_list = array(
				...
				'fb_agent_deleted_fields' => array(
					'default_value' => array(),
				),

				'fb_agent_deleted_sections' => array(
					'default_value' => array(),
				),

				'fb_agency_deleted_fields' => array(
					'default_value' => array(),
				),

				'fb_agency_deleted_sections' => array(
					'default_value' => array(),
				),
				...
				'property_management_page_id' => array(),
				'agent_agency_search_results_page_id' => array(),
...
//						'single-full-width-tiled' => __( 'With full-width tiled gallery', 'es' ),
				...
				'is_subscriptions_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_profile_requests_tab_enabled' => array(
					'default_value' => 1,
				),

				'is_agents_sorting_enabled' => array(
					'default_value' => 1,
				),

				'is_agent_contact_form_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_contact_form_enabled' => array(
					'default_value' => 1,
				),

				'is_agencies_sorting_enabled' => array(
					'default_value' => 1,
				),

				'is_agent_contact_button_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_contact_button_enabled' => array(
					'default_value' => 1,
				),

				'is_agent_position_enabled' => array(
					'default_value' => 1,
				),

				'is_agent_member_since_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_member_since_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_agents_wishlist_enabled' => array(
					'default_value' => 1,
				),

				'is_agencies_wishlist_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_agents_sharing_enabled' => array(
					'default_value' => 1,
				),

				'is_agencies_sharing_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_agents_enabled' => array(
					'default_value' => 1,
				),

				'is_agencies_enabled' => array(
					'default_value' => 1,
				),

				'manual_listing_approve' => array(
					'default_value' => false,
				),

				'is_frontend_management_enabled' => array(
					'default_value' => true,
				),
				...
				'agents_sorting_options' => array(
					'default_value' => array( 'newest', 'highest_rating', 'reviews' ),
					'values' => array(
						'newest' => __( 'Newest', 'es' ),
						'highest_rating' => __( 'Highest rating', 'es' ),
						'reviews' => __( 'Reviews', 'es' ),
					),
				),

				'agencies_sorting_options' => array(
					'default_value' => array( 'newest', 'highest_rating', 'reviews' ),
					'values' => array(
						'newest' => __( 'Newest', 'es' ),
						'highest_rating' => __( 'Highest rating', 'es' ),
				...
				'agents_default_sorting_option' => array(
					'default_value' => 'newest',
					'values' => array(
						'newest' => __( 'Newest', 'es' ),
						'highest_rating' => __( 'Highest rating', 'es' ),
				...
				'agencies_default_sorting_option' => array(
					'default_value' => 'newest',
					'values' => array(
						'newest' => __( 'Newest', 'es' ),
						'highest_rating' => __( 'Highest rating', 'es' ),
				...
				'requests_per_page' => array(
					'default_value' => 40,
				),

				'agent_listings_per_page' => array(
					'default_value' => 6,
				),

				'agency_agents_per_page' => array(
					'default_value' => 8,
				),

				'agency_listings_per_page' => array(
					'default_value' => 6,
				),

				'agent_comments_per_page' => array(
					'default_value' => 6,
				),

				'agency_comments_per_page' => array(
					'default_value' => 6,
				),
				...
				'wishlist_agents_per_page' => array(
					'default_value' => 42,
				),

				'wishlist_agencies_per_page' => array(
					'default_value' => 42,
				),
				...
				'terms_forms' => array(
					'default_value' => array( 'sign_up_form', 'request_form', 'comment_form' ),
					'values' => array(
						'sign_up_form' => __( 'Sign up', 'es' ),
						'request_form' => __( 'Request form', 'es' ),
						'comment_form' => __( 'Add new comment', 'es' ),
					),
				),
				...
				'is_agent_comments_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_comments_enabled' => array(
					'default_value' => 1,
				),

				'is_agent_commenting_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_commenting_enabled' => array(
					'default_value' => 1,
				),

				'is_agent_rating_enabled' => array(
					'default_value' => 1,
				),

				'is_agency_rating_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_agents_layout_switcher_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_pdf_enabled' => array(
					'default_value' => 1,
				),
				'is_pdf_map_enabled' => array(
					'default_value' => 1,
				),
				'pdf_map_zoom' => array(
					'default_value' => 16,
				),
				'pdf_flyer_layout' => array(
					'default_value' => 'single_photo',
					'values' => array(
						'single_photo' => __( 'Single photo', 'es' ),
						'photo_gallery' => __( 'Photo gallery', 'es' ),
					),
				),
				'pdf_phone' => array(),
				'pdf_address' => array(),
				...
				'pdf_logo_attachment_id' => array(),
				'default_property_image_id' => array(),
				'default_agent_avatar_attachment_id' => array(),
				'default_agency_avatar_attachment_id' => array(),
...
',
				...
				'responsive_breakpoints' => array(
					'default_value' => array(
						...
						'locations-grid' => array(
							'selector' => '.js-es-locations-grid',
							'breakpoints' => array(
								'es-locations-grid--xl' => array( 'min' => 1171, 'max' => 9999 ),
								'es-locations-grid--lg' => array( 'min' => 800, 'max' => 1170 ),
								'es-locations-grid--md' => array( 'min' => 510, 'max' => 800 ),
								'es-locations-grid--sm' => array( 'min' => 361, 'max' => 510 ),
								'es-locations-grid--xs' => array( 'min' => 1, 'max' => 360 ),
							),
						),
						'slideshow' => array(
							'selector' => '.js-es-p-slideshow',
							'breakpoints' => array(
								'es-p-slideshow--xl' => array( 'min' => 1171, 'max' => 9999 ),
								'es-p-slideshow--lg' => array( 'min' => 961, 'max' => 1170 ),
								'es-p-slideshow--md' => array( 'min' => 721, 'max' => 960 ),
								'es-p-slideshow--sm' => array( 'min' => 541, 'max' => 720 ),
								'es-p-slideshow--xs' => array( 'min' => 1, 'max' => 540 ),
							),
						),
						'entities' => array(
							'selector' => '.es-entities:not(.es-entities--ignore-responsive):not(.es-entities--grid), .es-entities:not(.es-entities--ignore-responsive):not(.es-entities--grid)',
							'breakpoints' => array(
								'es-entities--list'    => array( 'min' => 1140 ),
								'es-entities--list-lg'    => array( 'min' => 930 ),
								'es-entities--list-md'    => array( 'min' => 690 ),
								'es-entities--list-sm'    => array( 'min' => 510 ),
								'es-entities--list-xs'    => array( 'min' => 220 ),
							)
						),
						...
						'single-entity' => array(
							'selector' => '.js-es-entity-single',
							'breakpoints' => array(
								'es-entity-single--xsm' => array( 'min' => 400 ),
								'es-entity-single--sm'  => array( 'min' => 520 ),
								'es-entity-single--md'  => array( 'min' => 650 ),
								'es-entity-single--lg'  => array( 'min' => 800 ),
								'es-entity-single--xl'  => array( 'min' => 1000 )
							),
						),
						...
						'agent_search' => array(
							'selector' => '.js-es-search--agent',
							'breakpoints' => array(
								'es-search--sm'   => array( 'max' => 720, 'min' => 541 ),
								'es-search--xs' => array( 'max' => 540, 'min' => 1 ),
							),
						),
						...
						'plans' => array(
							'selector' => '.js-es-plans-container',
							'breakpoints' => array(
								'es-plans-container--md-lg' => array( 'min' => 800, 'max' => 1170 ),
								'es-plans-container--sm' => array( 'min' => 540, 'max' => 799 ),
								'es-plans-container--xs' => array( 'min' => 1, 'max' => 539 ),
							),
						),
						'compare' => array(
							'selector' => '.js-es-compare-wrapper',
							'breakpoints' => array(
								'es-compare--xl' => array( 'min' => 1140, 'max' => 99999 ),
								'es-compare--lg' => array( 'min' => 930, 'max' => 1140 ),
								'es-compare--md' => array( 'min' => 690, 'max' => 930 ),
								'es-compare--sm' => array( 'min' => 510, 'max' => 690 ),
								'es-compare--xs' => array( 'min' => 0, 'max' => 510 ),
							),
						),
					),
				),
				...
				'subscription_tr_subscriptions_btn' => array(
					'default_value' => __( 'Choose your plan', 'es' ),
				),

				'subscription_tr_otp_btn' => array(
					'default_value' => __( 'Make a one-time payment', 'es' ),
				),

				'subscription_tr_general_title' => array(
					'default_value' => __( 'Select your payment option', 'es' ),
				),

				'subscription_tr_general_subtitle' => array(
					'default_value' => '',
				),

				'subscription_tr_signup_title' => array(
					'default_value' => __( 'Congrats! Your profile was created', 'es' ),
				),

				'subscription_tr_signup_subtitle' => array(
					'default_value' => __( 'Almost done. Select your payment option.', 'es' ),
				),

				'subscription_tr_hl_with_subscriptions_title' => array(
					'default_value' => __( 'You’re hit your 1 basic listing limit. Upgrade your plan or make a one-time payment.', 'es' ),
				),

				'subscription_tr_hl_with_subscriptions_subtitle' => array(
					'default_value' => '',
				),

				'subscription_tr_hl_with_otp_title' => array(
					'default_value' => __( 'You’re hit your listing limits. Make a one-time payment or contact your admin.', 'es' ),
				),

				'subscription_tr_hl_with_otp_subtitle' => array(
					'default_value' => '',
				),

				'subscription_tr_hl_title' => array(
					'default_value' => __( 'You’re hit your listing limits. Contact your admin.', 'es' ),
				),

				'subscription_tr_subtitle' => array(
					'default_value' => '',
				),

				'subscription_tr_featured_listings_description' => array(
					'default_value' => '',
				),

				'otp_subscription_tr_basic_listings_description' => array(
					'default_value' => '',
				),

				'otp_subscription_tr_featured_listings_description' => array(
					'default_value' => '',
				),

				'is_paypal_payment_method_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_otp_enabled' => array(
					'default_value' => 1
				),

				'otp_is_basic_bonus_enabled' => array(
					'default_value' => 1
				),
				'otp_free_featured_count' => array(
					'default_value' => 1
				),
				'otp_free_basic_count' => array(
					'default_value' => 10
				),
				'otp_basic_price' => array(),
				'otp_featured_price' => array(),
				'otp_basic_min_count' => array(
					'default_value' => 1,
				),
				'otp_featured_min_count' => array(
					'default_value' => 0,
				),
				...
				'pricing_page_id' => array(),

				'is_admin_listing_added_by_agent_enabled' => array(
					'default_value' => 1,
				),

				'admin_listing_added_by_agent_email_subject' => array(
					'default_value' => 'Agent {agent_name} added new listing.'
				),

				'admin_listing_added_by_agent_email_content' => array(
					'default_value' => 'Hi Admin,<br>Agent {agent_name} published new listing <a href="{post_link}">#{post_id}</a>. You can review or unpublish it here <a href="{admin_permalink}">here</a>.',
				),
				...
				'is_new_agent_confirm_enabled' => array(
					'default_value' => 1,
				),

				'new_agent_confirm_email_content' => array(
					'default_value' => '<p>Thank you for your registration!</p><p>Please approve your registration using link below.</p><p>{confirmation_link}</p><p>Your account information is below</p><b>Username: </b>{user_login}<p>You can enter your account <a href="{profile_link}">here</a>.</p>',
				),

				'new_agent_confirm_email_subject' => array(
					'default_value' => _x( 'Registration confirmation email', 'user email subject', 'es' ),
				),

				'is_new_user_registered_admin_enabled' => array(
					'default_value' => 1,
				),
				...
				'is_request_info_email_from_enabled' => array(
					'default_value' => false,
				),
				...
				'request_agent_info_email_subject' => array(
					'default_value' => _x( 'New request for agent #{post_id} submitted', 'user email subject', 'es' ),
				),

				'request_agent_info_email_content' => array(
					'default_value' => '<p>Request agent <a href="{post_link}" target="_blank">#{post_id}</a></p><br><b>Name: </b>{name}<br><b>Email: </b>{email}<br><b>Phone: </b>{phone}<br><b>Agent Link: </b><a target="_blank" href="{post_link}">{post_link}</a><br><b>Request: </b>{request}',
				),

				'request_agency_info_email_subject' => array(
					'default_value' => _x( 'New request for agency #{post_id} submitted', 'user email subject', 'es' ),
				),

				'request_agency_info_email_content' => array(
					'default_value' => '<p>Request agency <a href="{post_link}" target="_blank">#{post_id}</a></p><br><b>Name: </b>{name}<br><b>Email: </b>{email}<br><b>Phone: </b>{phone}<br><b>Agency Link: </b><a target="_blank" href="{post_link}">{post_link}</a><br><b>Request: </b>{request}',
				),

				'is_agent_listing_submitted_enabled' => array(
					'default_value' => 1,
				),

				'agent_listing_submitted_email_subject' => array(
					'default_value' => 'New listing submitted. Wait for approval.',
				),

				'agent_listing_submitted_email_content' => array(
					'default_value' => '<p>Hi {agent_name}.</p>Your listing <a target="_blank" href="{post_link}">#{post_id}</a> was successfully submitted. Once it is approved by Admin, it will be published and visible to your website visitors.',
				),

				'is_agent_listing_published_enabled' => array(
					'default_value' => 1,
				),

				'agent_listing_published_email_subject' => array(
					'default_value' => 'Your listing is published!',
				),

				'agent_listing_published_email_content' => array(
					'default_value' => 'Congratulations! Your listing <a target="_blank" href="{post_link}">#{post_id}</a> is approved and published.',
				),

				'is_admin_listing_published_enabled' => array(
					'default_value' => 1,
				),

				'admin_listing_published_email_subject' => array(
					'default_value' => 'Agent {agent_name} published new listing.',
				),

				'admin_listing_published_email_content' => array(
					'default_value' => '<p>Hi Admin.</p>Agent {agent_name} published new listing <a target="_blank" href="{post_link}">#{post_id}</a>. You can review or unpublish it <a href="{admin_permalink}">here</a>.',
				),

				'subscription_expired_email_content' => array(
					'default_value' => '<p>Hi {agent_name}.</p>Please note that your subscription plan ended. You need to renew your plan <a href="{upgrade_plan_link}">here</a>. Otherwise your listings will be unpublished.<p>Thank you.</p>',
				),

				'subscription_expired_email_subject' => array(
					'default_value' => 'Your subscription ended. Please prolong it to publish your listings.',
				),

				'subscription_upgrade_email_content' => array(
					'default_value' => '<p>Hi, {agent_name}</p>You\'re hit your Plan listings limit. Please upgrade your plan or make a one-time payment <a href="{upgrade_plan_link}">here</a>.',
				),

				'subscription_upgrade_email_subject' => array(
					'default_value' => 'Please upgrade your plan.',
				),

				'subscription_upgraded_email_content' => array(
					'default_value' => '<p>Hi, {agent_name}</p>Congratulations! You\'ve successfully upgraded your Subscription plan and now can add more listings!<br>Thank you.',
				),

				'subscription_upgraded_email_subject' => array(
					'default_value' => 'You successfully upgraded your plan!',
				),

				'subscription_otp_payed_email_content' => array(
					'default_value' => '<p>Hi, {agent_name}</p>We thank you for your payment. Now your can publish your listings.',
				),

				'subscription_otp_payed_email_subject' => array(
					'default_value' => 'Thank you for your payment!',
				),

				'subscription_user_subscribed_email_content' => array(
					'default_value' => '<p>Hi, {agent_name}</p>Thank you for your subscription! Now you can add your listings according to your Subscription Plan.',
				),

				'subscription_user_subscribed_email_subject' => array(
					'default_value' => 'You\'re successfully subscribed!',
				),

				'subscription_renew_email_content' => array(
					'default_value' => '<p>Hi, {agent_name}</p>Your subscription plan was successfully renewed.<br>Thank you.',
				),

				'subscription_renew_email_subject' => array(
					'default_value' => 'You successfully renewed your plan!',
				),

				'is_compare_enabled' => array(
					'default_value' => '1',
				),
				...
				'is_compare_auth_required' => array(
					'default_value' => 1,
				),

				'compare_max_entities_num' => array(
					'default_value' => 4,
				),

				'compare_max_entities_num_error' => array(
					'default_value' => __( 'Sorry, but you can compare only 4 properties.', 'es' ),
				),

				'compare_fields' => array(
					'default_value' => array( 'price', 'bedrooms', 'bathrooms', 'half_baths', 'area', 'lot_size', 'floors', 'floor_level', 'es_feature', 'es_amenity' )
				)
			);
	...
	public function get_default_value( $name ) {
		...
		return isset( $settings[ $name ]['default_value'] ) ? $settings[ $name ]['default_value'] : null;
	}
	...
	public function save_one( $name, $value ) {
		...
		$value = apply_filters( 'es_before_save_option_value', $value, $name, $this );
