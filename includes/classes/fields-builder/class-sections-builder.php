...
class Es_Sections_Builder extends Es_Fields_Builder_Item {
	...
	public static function get_table_name() {
		global $wpdb;
		return apply_filters( 'es_sections_builder_get_table_name', $wpdb->prefix . 'realtek_fb_sections' );
	}
	...
	public static function prepare_item_data( $section_data ) {
		$valid_cols = array( 'id', 'label', 'options', 'machine_name', 'entity_name', 'is_visible', 'is_visible_for', 'is_pdf_visible', 'order' );
