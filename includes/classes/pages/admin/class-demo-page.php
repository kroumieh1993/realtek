...
class Es_Demo_Page {
    ...
    public static function setup_demo() {
        ...
        if ( wp_verify_nonce( $nonce, 'es_demo_content' ) ) {
			...
			$agent_type = es_post( 'agent_type' );
            $settings['country'] = $country;

			if ( $agent_type ) {
				ests_save_option( 'is_agencies_enabled', $agent_type == 'agency' );
				ests_save_option( 'is_agents_enabled', $agent_type == 'agency' );
				ests_save_option( 'is_subscriptions_enabled', $agent_type == 'agency' );
			}
    ...
    public static function get_demo_pages() {
        return array(
            ...
            'pricing' => array(
	            'title' => __( 'Pricing', 'es' ),
	            'content' => '[es_subscriptions]',
	            'setting' => 'pricing_page_id',
            ),
            'map-view' => array(
            ...
            'profile' => array(
                'title' => __( 'Profile', 'es' ),
                'content' => '[es_profile]',
	            'setting' => 'profile_page_id',
            ),
            'frontend-management' => array(
                'title' => __( 'Properties Management', 'es' ),
                'content' => '[property_management]',
	            'setting' => 'property_management_page_id',
            ),
            'agents' => array(
                'title' => __( 'Agents', 'es' ),
                'content' => '[es_my_agents enable_search="1"]',
	            'setting' => 'agent_agency_search_results_page_id'
            ),
            'agencies' => array(
                'title' => __( 'Agencies', 'es' ),
                'content' => '[es_my_agencies enable_search="1"]',
                'setting' => 'agent_agency_search_results_page_id'
            ),
        );
    }
