...
class Es_Settings_Page {
	...
	public static function create_recommended_page() {
		...
		if ( check_ajax_referer( 'es_settings_create_page', '_wpnonce' ) ) {
			if ( current_user_can( 'manage_options' ) ) {
				...
				$response = es_notification_ajax_response( __( 'You have no permissions to do action', 'es' ), 'error' );
			}
		} else {
	...
	public static function render() {
		...
		$tabs = apply_filters( 'es_settings_page_tabs', array(
			...
			'subscriptions' => array(
				'label' => _x( 'Subscriptions', 'plugin settings', 'es' ),
				'template' => es_locate_template( 'admin/settings/tabs/subscriptions-tab.php' )
			),
			'agents' => array(
				'label' => _x( 'Agents', 'plugin settings', 'es' ),
				'template' => es_locate_template( 'admin/settings/tabs/agents-tab.php' )
			),
			'agencies' => array(
				'label' => _x( 'Agencies', 'plugin settings', 'es' ),
				'template' => es_locate_template( 'admin/settings/tabs/agencies-tab.php' )
			),
			'agent-agencies-search' => array(
				'label' => _x( 'Agent & Agency search', 'plugin settings', 'es' ),
				'template' => es_locate_template( 'admin/settings/tabs/agent-agencies-search-tab.php' )
			),
            'seo' => array(
			...
			'compare' => array(
				'label' => _x( 'Comparing properties', 'plugin settings', 'es' ),
				'template' => es_locate_template( 'admin/settings/tabs/compare-properties-tab.php' )
			),
			'slugs' => array(
			...
			'emails' => array(
				'label' => _x( 'Emails', 'plugin settings', 'es' ),
				'template' => es_locate_template( 'admin/settings/tabs/emails-tab.php' )
			),
