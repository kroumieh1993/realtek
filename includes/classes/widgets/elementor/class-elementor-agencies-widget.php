 ...
 */
class Elementor_Es_Agencies_Widget extends Elementor_Es_Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_custom_control( 'agencies_id', array(
			'label' => __( 'Agencies IDs', 'es' ),
			'type' => 'text',
			'description' => __( 'Comma separated agencies IDs', 'es' ),
		) );
...
//		$settings = wp_array_slice_assoc( $settings, $this->get_custom_controls_keys() );
		...
		$shortcode = es_get_shortcode_instance( 'es_my_agencies', $settings );
