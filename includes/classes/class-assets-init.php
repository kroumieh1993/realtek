...
class Es_Assets {
	...
	public static function frontend_assets() {
		...
		$management_deps = array( 'jquery', 'es-management' );
		...
		wp_localize_script( 'es-property-metabox', 'EstatikMetabox', array(
			...
			'tr' => es_js_get_translations(),
			'nonces' => array(
				'agents_nonce' => wp_create_nonce( 'get_select2_agents' ),
			)
		) );
		...
		$localize = array(
			...
			'settings' => array(
				...
				'map_zoom_min' => ests( 'map_zoom_min' ),
				'map_zoom_max' => ests( 'map_zoom_max' ),
				'can_zoom' => current_user_can( 'administrator' ),
				...
				'search_locations_init_priority' => array( 'country', 'state', 'province', 'city' ),
