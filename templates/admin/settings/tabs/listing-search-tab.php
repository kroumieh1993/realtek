...
?>
    ...
    <div class='es-accordion js-es-accordion'>
        ...
        <div class='es-accordion__body'>
            <?php es_settings_field_render( 'is_same_price_for_categories_enabled', array(
                'type' => 'switcher',
            ...
            es_settings_field_render( 'custom_prices_list', array(
                ...
                'fields' => array(
                    'category' => array(
                        ...
                        'attributes' => array(
                            'placeholder' => __( 'All', 'plugin settings taxonomy placeholder', 'es' ),
                        ),
                    ),
                    'type' => array(
                        'label' => __( 'Type', 'es' ),
        ...
        <div class='es-accordion js-es-accordion'>
            ...
            <div class='es-accordion__body'>
                ...
                es_settings_field_render( "search_min_{$field}_list", array(
                    'label' => __( "Minimum {$field} list", 'es' ),
                    'type' => 'text',
                    'description' => $comma_desc,
                ...
                es_settings_field_render( "search_max_{$field}_list", array(
                    'label' => __( "Maximum {$field} list", 'es' ),
                    'type' => 'text',
                    'description' => $comma_desc,
                    'after' => '</div>',
                ) ); ?>
        ...
        <div class='es-accordion js-es-accordion'>
            ...
            <div class='es-accordion__body'>
	            <?php es_settings_field_render( "search_min_{$field}_list", array(
		            'label' => sprintf( __( "Minimum $label list, %s", 'es' ), ests_label( 'area_unit' ) ),
		            'type' => 'textarea',
		            'caption' => $price_desc,
                    'attributes' => array(
                        'rows' => 5,
	            ...
	            es_settings_field_render( "search_max_{$field}_list", array(
		            'label' => sprintf( __( "Maximum $label list, %s", 'es' ), ests_label( 'lot_size_unit' ) ),
		            'type' => 'textarea',
		            'caption' => $price_desc,
		            'attributes' => array(
			            'rows' => 5,
